...
> **Disclaimer:** This project was set up mainly as an **educational resource for myself** to understand the SINGER algorithm by reimplementing it from scratch. All intellectual credit belongs to the original authors. For production use, the authoritative reference, and the optimised C++ implementation, please refer to the original repository: **[github.com/popgenmethods/SINGER](https://github.com/popgenmethods/SINGER)**
